"""
This is the main script for running the OCTDiff model.
"""
...
print(sys.path)
from model.utils.utils import dict2namespace, get_runner, namespace2dict
...
def parse_args_and_config():
    ...
    parser.add_argument('-c', '--config', type=str, default='base.yml', help='Path to the config file')
